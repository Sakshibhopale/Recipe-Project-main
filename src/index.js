...
var typed = new Typed('.auto-type', {
    strings: [" 🍳 Welcome 👋 to Sakshi's Kitchen 🍽️"],
    typeSpeed: 19,
    startDelay: 2000,
    showCursor: false,
    onComplete: function () {
...
function moreDesctoWelcome() {
    const moreDesctoWelcome_content =
        ...
        <span class="st"><span class="emoji">🍲</span> At Sakshi's Kitchen, we're more than just a collection of recipes; we're a community of food enthusiasts, passionate about sharing the joy of cooking. Whether you're a seasoned chef or a kitchen newbie, our diverse array of recipes caters to every taste, skill level, and craving.
        </span>
